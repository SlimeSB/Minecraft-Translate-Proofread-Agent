...
11 项规则：空翻译/唱片名/占位符完整性/特殊标签/tellraw JSON/中文标点/尾空格/能量单位/省略号/声音字幕/树木名。全部纯 Python，零 LLM 成本。
